...
namespace SelectByFilterInstaller
{
    ...
    {
        public static string versionValue = "1.0.7";
        static void Main()
        {
            var project = new ManagedProject($"AEC Spot - Select By Filters {versionValue}",
                              new Dir(@"CommonAppDataFolder\Autodesk\ApplicationPlugins",
                                  new Dir(@"SelectByFilter.bundle",
                                  new File(@"..\SelectByFilter\PackageContents.xml"),
                                      new Dir(@"Contents",
                                       new Dir(@"2018",
                                            new Dir(@"Resources", new Dir(@"Images", new Files(@"..\SelectByFilter\bin\Debug\2018\Resources\Images\*.png"))),
                                            new File(@"..\SelectByFilter\SelectByFilter.addin"),
                                            new File(@"..\SelectByFilter\bin\Debug\2018\SelectByFilter.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\SelectByFilter\bin\Debug\2018\AECSpot.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2018\Xceed.Wpf.AvalonDock.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2018\Xceed.Wpf.AvalonDock.Themes.Aero.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2018\Xceed.Wpf.AvalonDock.Themes.Metro.dll",
                                                 new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2018\Xceed.Wpf.AvalonDock.Themes.VS2010.dll",
                                                 new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2018\Xceed.Wpf.Toolkit.dll",
                                                 new FilePermission("Everyone", GenericPermission.All))
                                         ...
                                         new Dir(@"2019",
                                            new Dir(@"Resources", new Dir(@"Images", new Files(@"..\SelectByFilter\bin\Debug\2021\Resources\Images\*.png"))),
                                            new File(@"..\SelectByFilter\SelectByFilter.addin",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\SelectByFilter\bin\Debug\2021\SelectByFilter.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\SelectByFilter\bin\Debug\2021\AECSpot.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2021\Xceed.Wpf.AvalonDock.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2021\Xceed.Wpf.AvalonDock.Themes.Aero.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2021\Xceed.Wpf.AvalonDock.Themes.Metro.dll",
                                                 new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2021\Xceed.Wpf.AvalonDock.Themes.VS2010.dll",
                                                 new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\SelectByFilter\bin\Debug\2021\Xceed.Wpf.Toolkit.dll",
                                                 new FilePermission("Everyone", GenericPermission.All))
                                            ...
                                            new Dir(@"Resources", new Dir(@"Images", new Files(@"..\SelectByFilter\bin\Debug\2021\Resources\Images\*.png"))),
                                            new File(@"..\SelectByFilter\SelectByFilter.addin", new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\SelectByFilter\bin\Debug\2021\SelectByFilter.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\SelectByFilter\bin\Debug\2021\AECSpot.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            ...
                                            new Dir(@"Resources", new Dir(@"Images", new Files(@"..\SelectByFilter\bin\Debug\2025\Resources\Images\*.png"))),
                                            new File(@"..\SelectByFilter\SelectByFilter.addin", new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\SelectByFilter\bin\Debug\2025\SelectByFilter.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\SelectByFilter\bin\Debug\2025\AECSpot.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                    
                                             new File(@"..\SelectByFilter\bin\Debug\2025\SelectByFilter.deps.json",
                                                 new FilePermission("Everyone", GenericPermission.All)),
    ...
    public class CustomActions
    {
        ...
        public static ActionResult CheckRevitProcess(Session session)
        {
            try
            {
                ...
                if (!System.IO.File.Exists($"{appDataPath}\\Autodesk\\ApplicationPlugins\\SelectByFilter.bundle\\PackageContents.xml"))
                {
                    //MessageBox.Show(System.IO.File.Exists($"{appDataPath}\\Autodesk\\ApplicationPlugins\\SelectByFilter.bundle\\PackageContents.xml").ToString(), $"{appDataPath}\\Autodesk\\ApplicationPlugins\\SelectByFilter.bundle\\PackageContents.xml");
                    return ActionResult.Success;
                }
                else
                {
                ...
                if (processes.Length > 0)
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        string basePath = Environment.ExpandEnvironmentVariables("%AppDataFolder%\\Autodesk\\ApplicationPlugins\\SelectByFilter.bundle\\Contents");
                        List<string> filePaths = new List<string>();

                        for (int year = 2018; year <= 2025; year++)
                        {
                            //string filePath = $"{basePath}\\{year}\\SelectByFilter.dll";
                            //bool overwrittable = WaitForFilesToBeOverwritable(filePath);
                            //if (!overwrittable)
                            //{
                            //    MessageBox.Show($"The file SelectByFilter.dll {year} is still in use", "Warning");
