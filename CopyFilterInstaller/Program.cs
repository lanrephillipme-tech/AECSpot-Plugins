...
namespace CopyFilterInstaller
{
    internal class Program
    {
        public static string versionValue = "1.0.17";
        static void Main()
        {
            var project = new ManagedProject($"AEC Spot - Copy Filters {versionValue}",
                              new Dir(@"CommonAppDataFolder\Autodesk\ApplicationPlugins",
                                  new Dir(@"CopyFilter.bundle",
                                  new File(@"..\CopyFilter\PackageContents.xml"),
                                      new Dir(@"Contents",
                                       new Dir(@"2018",
                                            new Dir(@"Resources", new Dir(@"Images", new Files(@"..\CopyFilter\bin\Debug\2018\Resources\Images\*.png"))),
                                            new File(@"..\CopyFilter\CopyFilter.addin"),
                                            new File(@"..\CopyFilter\bin\Debug\2018\CopyFilter.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\CopyFilter\bin\Debug\2018\AECSpot.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2018\Xceed.Wpf.AvalonDock.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2018\Xceed.Wpf.AvalonDock.Themes.Aero.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2018\Xceed.Wpf.AvalonDock.Themes.Metro.dll",
                                                 new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2018\Xceed.Wpf.AvalonDock.Themes.VS2010.dll",
                                                 new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2018\Xceed.Wpf.Toolkit.dll",
                                                 new FilePermission("Everyone", GenericPermission.All))
                                         ...
                                         new Dir(@"2019",
                                            new Dir(@"Resources", new Dir(@"Images", new Files(@"..\CopyFilter\bin\Debug\2021\Resources\Images\*.png"))),
                                            new File(@"..\CopyFilter\CopyFilter.addin"),
                                            new File(@"..\CopyFilter\bin\Debug\2021\CopyFilter.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\CopyFilter\bin\Debug\2021\AECSpot.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2021\Xceed.Wpf.AvalonDock.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2021\Xceed.Wpf.AvalonDock.Themes.Aero.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2021\Xceed.Wpf.AvalonDock.Themes.Metro.dll",
                                                 new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2021\Xceed.Wpf.AvalonDock.Themes.VS2010.dll",
                                                 new FilePermission("Everyone", GenericPermission.All)),
                                             new File(@"..\CopyFilter\bin\Debug\2021\Xceed.Wpf.Toolkit.dll",
                                                 new FilePermission("Everyone", GenericPermission.All))
                                            ...
                                            new Dir(@"Resources", new Dir(@"Images", new Files(@"..\CopyFilter\bin\Debug\2025\Resources\Images\*.png"))),
                                            new File(@"..\CopyFilter\CopyFilter.addin"),
                                            new File(@"..\CopyFilter\bin\Debug\2025\CopyFilter.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                                            new File(@"..\CopyFilter\bin\Debug\2025\AECSpot.dll",
                                                new FilePermission("Everyone", GenericPermission.All)),
                    
                                             new File(@"..\CopyFilter\bin\Debug\2025\CopyFilter.deps.json",
                                                 new FilePermission("Everyone", GenericPermission.All)),
    ...
    public class CustomActions
    {
        ...
        public static ActionResult CheckRevitProcess(Session session)
        {
            try
            {
                ...
                if (!System.IO.File.Exists($"{appDataPath}\\Autodesk\\ApplicationPlugins\\CopyFilter.bundle\\PackageContents.xml"))
              // if (!System.IO.File.Exists($"CommonAppDataFolder\\Autodesk\\ApplicationPlugins\\CopyFilter.bundle\\PackageContents.xml"))
                {
                    //MessageBox.Show(System.IO.File.Exists($"{appDataPath}\\Autodesk\\ApplicationPlugins\\CopyFilter.bundle\\PackageContents.xml").ToString(), $"{appDataPath}\\Autodesk\\ApplicationPlugins\\CopyFilter.bundle\\PackageContents.xml");
                    return ActionResult.Success;
                }
                else
                {
                ...
                if (processes.Length > 0)
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        string basePath = Environment.ExpandEnvironmentVariables("CommonAppDataFolder\\Autodesk\\ApplicationPlugins\\CopyFilter.bundle\\Contents");
                        List<string> filePaths = new List<string>();

                        for (int year = 2018; year <= 2025; year++)
                        {
                            //string filePath = $"{basePath}\\{year}\\CopyFilter.dll";
                            //bool overwrittable = WaitForFilesToBeOverwritable(filePath);
                            //if (!overwrittable)
                            //{
                            //    MessageBox.Show($"The file CopyFilter.dll {year} is still in use", "Warning");
